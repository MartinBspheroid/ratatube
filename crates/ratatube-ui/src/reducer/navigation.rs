...
pub(crate) fn navigate(ui: &mut UiState, domain: &DomainState, view: View) {
    ui.view = view;
    ui.selected_index = 0;
...
pub(crate) fn close_help(ui: &mut UiState) {
    ui.view = ui.help_return_view;
    ui.help_scroll = 0;
}

/// Scroll the help document by signed rows.
pub(crate) fn scroll_help(ui: &mut UiState, delta: i32) {
    if ui.view == View::Help {
...
pub(crate) fn cycle_home_section(ui: &mut UiState, domain: &DomainState, delta: i32) {
...
pub(crate) fn toggle_search_detail(ui: &mut UiState) {
...
pub(crate) fn select_next(ui: &mut UiState, domain: &DomainState) {
...
pub(crate) fn select_previous(ui: &mut UiState) {
