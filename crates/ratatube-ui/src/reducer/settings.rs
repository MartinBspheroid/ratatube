...
pub(crate) fn close(ui: &mut UiState) {
...
pub(crate) fn cycle_tab(ui: &mut UiState) {
...
pub(crate) fn move_selection(ui: &mut UiState, delta: i32) {
    if let Some(settings) = &mut ui.settings {
...
pub(crate) fn adjust(ui: &mut UiState, delta: i32) {
    if let Some(settings) = &mut ui.settings {
        match settings.tab {
...
pub(crate) fn submit(ui: &mut UiState) -> Vec<Effect> {
